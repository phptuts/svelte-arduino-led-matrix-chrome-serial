var app = (function () {
    ...
    /* src/Led.svelte generated by Svelte v3.18.2 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			dispose = listen(div, "click", /*onChangeLed*/ ctx[1]);
    		},
    		p(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*isOn*/ 4) {
    			 $$invalidate(0, backgroundColor = isOn ? "red" : "white");
    		}
    	};
    ...
    function create_each_block_1(ctx) {
    	...
    	led.$on("changeLed", /*onChangeLed*/ ctx[6]);
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			const led_changes = {};
    			if (dirty & /*leds*/ 1) led_changes.isOn = /*isOn*/ ctx[12];
    			led.$set(led_changes);
    		},
    		i(local) {
    			if (current) return;
    ...
    function create_each_block(ctx) {
    	let section;
    	let current;
    	let each_value_1 = /*rowLeds*/ ctx[9];
    	let each_blocks = [];
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*leds, onChangeLed*/ 65) {
    				each_value_1 = /*rowLeds*/ ctx[9];
    				let i;
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			div0 = element("div");
    			h1 = element("h1");
    			h1.textContent = "Led Matrix Draw";
    			t2 = space();
    			button0 = element("button");
    			button0.textContent = "Connect to USB";
    			t4 = space();
    			button1 = element("button");
    			button1.textContent = "Clear Screen";
    			t6 = space();
    		...
    		m(target, anchor) {
    			...
    			dispose = [
    				listen(button0, "click", /*connectUSB*/ ctx[4]),
    				listen(button1, "click", /*clearScreen*/ ctx[5])
    			];
    		},
    		p(ctx, [dirty]) {
    			if (/*showError*/ ctx[1]) {
    			...
    			if (!current || dirty & /*ledString*/ 8) set_data(t10, /*ledString*/ ctx[3]);
    		},
    		i(local) {
    			if (current) return;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	async function connectUSB() {
    		...
    		try {
    			...
    			console.error(e);
    			$$invalidate(2, errorMessage = e.message);
    		}
    	}

    	function clearScreen() {
    		$$invalidate(0, leds = lodash.range(0, 8).map(() => lodash.range(0, 8).map(() => false)));
    	}
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*leds, writer, ledString*/ 137) {
    			 {
    				$$invalidate(3, ledString = lodash.clone(leds).reverse().reduce(
    					(prev, next, index) => {
    						const startingString = index === 0 ? "" : ":";
    						return prev + startingString + next.map(isOn => isOn ? "1" : "0").join(":");
    					},
    					""
    				) + "|");
    	...
    	return [leds, showError, errorMessage, ledString, connectUSB, clearScreen, onChangeLed];
    }
